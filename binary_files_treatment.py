...
def mergeBinFilesToHour(elsysProsjektOpptaksfilerMappeServer, elsysProsjektOpptaksfilerTimerMappeServer):
    ...
    for hour in hoursInDay:
        ...
        os.system('cd {elsysProsjektOpptaksfilerMappeServer} && mv {filename} {elsysProsjektOpptaksfilerTimerMappeServer}')
        
# mergeBinFilesToHour(elsysProsjektOpptaksfilerMappeServer, elsysProsjektOpptaksfilerTimerMappeServer)